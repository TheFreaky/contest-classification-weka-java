...
public class WekaClassifier {
    ...
    private static final String ALL_DATA = "src/main/resources/dataset/all.txt";
...
//            if (!new File(TRAIN_ARFF_ARFF).exists()) {
                allData = loadRawDataset(ALL_DATA);
                RemovePercentage rp = new RemovePercentage();
                rp.setPercentage(20);
                rp.setInputFormat(allData);
                trainData = Filter.useFilter(allData, rp);
...
//            } else {
//                allData = loadRawDataset(ALL_DATA);
                RemovePercentage rp2 = new RemovePercentage();
                rp2.setPercentage(20);
                rp2.setInvertSelection(true);
                rp2.setInputFormat(allData);
                testData = Filter.useFilter(allData, rp2);
...
//            Stemmer stemmer = new SnowballStemmer("russian");
    ...
    public String evaluate() {
        try {
            ...
            eval.crossValidateModel(classifier, testData, 5, new Random());
//            eval.evaluateModel(classifier, testData);
    ...
    public Instances loadRawDataset(String filename) {
        ...
        Instances dataset = new Instances("Contest classifier", wekaAttributes, 10);
